...
use function Anarchitecture\combinatorics\iterable_allocations;

final class IterableAllocationsTest extends TestCase {

    public function testItThrowsWhenTotalIsNegative() : void {

        $this->expectException(InvalidArgumentException::class);

        iterable_allocations(-1);
    }
    ...
    public function testEveryAllocationSumsToTotal() : void {
        ...
        foreach (($stage |> iterable_allocations($total)) as $allocation) {
